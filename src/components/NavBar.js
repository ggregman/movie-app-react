...
export const NavBar = () => {
    ...
    return (
        ...
        <Container h="75px" color="black" display="flex" alignItems="center" justifyContent="space-between" maxW='100%' bg='white' mb="50px">
            ...
            <Center>
                <Text margin='50x' fontWeight='bold'>Movies</Text>
                <Text margin='50x' fontWeight='bold'>TV Shows</Text>
            </Center>
...
import {
    Box, CloseButton, Flex, HStack, VStack, IconButton, useColorModeValue, useDisclosure
    ...
    return (
        ...
        <>
            <Heading bg={bg} w="full" px={{ base: 2, sm: 4 }} py={5} shadow="md">
                ...
                <Flex alignItems="center" justifyContent="space-between" mx="auto" paddingX='100px'>
                    ...
                    <HStack display="flex" alignItems="center" spacing={1}>
                        ...
                        <Box display={{ base: "inline-flex", md: "none" }}>
                            ...
                            <IconButton display={{ base: "flex", md: "none" }} aria-label="Open menu" fontSize="20px" color={useColorModeValue("gray.800", "inherit")}
                                variant="ghost" icon={<HamburgerIcon />} onClick={mobileNav.onOpen} />

                            <VStack pos="absolute" top={0} left={0} right={0} display={mobileNav.isOpen ? "flex" : "none"} flexDirection="column"
                                p={2} pb={4} m={2} bg={bg} spacing={3} rounded="sm" shadow="sm">
